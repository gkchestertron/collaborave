json.extract! @project, :name, :author_id, :id

json.tracks do
	json.array! @project.tracks do |track|
		json.name track.name
		json.id track.id

		json.filters do
			json.array! track.filters do |filter|
		...
		json.regions do
			json.array! track.regions do |region|
				json.id region.id
				json.path region.path
				json.start_time region.start_time
				json.filters do
					json.array! region.filters do |filter|
						json.name filter.name
						json.track_id filter.track_id
						json.settings filter.settings
						json.track_diff_id filter.track_diff_id
...
json.versions do
	json.array! @project.versions do |version|
		json.id version.id
